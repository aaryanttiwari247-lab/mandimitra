          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-200">{t("auth.farmerPortal")}</p>
              </div>
            </div>
      ...
      <header className="border-b border-[#0F3817] bg-gradient-to-r from-[#13491E] via-[#1B5E2B] to-[#13491E] text-white shadow-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium text-white transition hover:text-emerald-200 cursor-pointer"
          >
