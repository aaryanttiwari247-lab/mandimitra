    ...
    <main className="min-h-screen bg-gradient-to-b from-[#EFF5F0] via-[#F8FAF7] to-[#F3F7F4] text-[#111827]">
      ...
      <section className="px-5 py-8 sm:px-8">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          {/* ====================================================
              HORIZONTAL FILING FLOW CHART (3-STAGE ADMINISTRATIVE MOVEMENT)
          ==================================================== */}
          {(() => {
            const officialFilingStages = [
              {
                id: "VERIFIED",
                stepNumber: "01",
                title: "Farmer Verified",
                description: "Farmer identity, Aadhaar link, and slot booking credentials certified.",
                icon: ShieldCheck,
                completed:
              ...
              },
              {
                ...
                description: "Weighbridge gross & tare weighment, quality assessment, and MSP application.",
                icon: Scale,
                completed:
                  currentStatus === "PROCESSING" ||
                  currentStatus === "COMPLETED",
            ...
            return (
              <div className="mt-7 rounded-3xl border border-gray-200 bg-white p-5 sm:p-7 shadow-sm">
